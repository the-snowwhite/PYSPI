...
#Send two characters
spibus0.write_buffer[0]=chr(0xFF)
spibus0.write_buffer[1]=chr(0x00)
spibus0.write_buffer[2]=chr(0x00)
spibus0.write_buffer[3]=chr(0x01)
spibus0.write_buffer[4]=chr(0x01)
